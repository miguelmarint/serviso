    ...
    <header id="header" class="fixed-top">
        <div class="container">
            <div class="logo float-left">
                <a href="#intro" class="scrollto"><img src="{{ asset('images/logo.png') }}" alt=""
                        class="img-fluid" /></a>
            </div>
            ...
            <div class="container">
                ...
                <div class="row about-extra">
                    <div class="col-lg-6 wow fadeInUp">
                        <img src="{{ asset('images/about-extra-1.svg') }}" class="img-fluid" alt="" />
                    </div>
                ...
                <div class="row about-extra">
                    <div class="col-lg-6 wow fadeInUp order-1 order-lg-2">
                        <img src="{{ asset('images/about-extra-2.svg') }}" class="img-fluid" alt="" />
                    </div>
                ...
                <div class="row portfolio-container">
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('images/portfolio/app1.jpg') }}" class="img-fluid" alt="" />
                            <div class="portfolio-info">
                                <h4><a href="#">App 1</a></h4>
                                <p>App</p>
                                <div>
                                    <a :href="asset('images/portfolio/app1.jpg')}}" data-lightbox="portfolio"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web" data-wow-delay="0.1s">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('images/portfolio/web3.jpg') }}" class="img-fluid" alt="" />
                            <div class="portfolio-info">
                                <h4><a href="#">Web 3</a></h4>
                                <p>Web</p>
                                <div>
                                    <a :href="asset('images/portfolio/web3.jpg')}}" class="link-preview"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app" data-wow-delay="0.2s">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('images/portfolio/app2.jpg') }}" class="img-fluid" alt="" />
                            <div class="portfolio-info">
                                <h4><a href="#">App 2</a></h4>
                                <p>App</p>
                                <div>
                                    <a :href="asset('images/portfolio/app2.jpg')}}" class="link-preview"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('images/portfolio/card2.jpg') }}" class="img-fluid" alt="" />
                            <div class="portfolio-info">
                                <h4><a href="#">Card 2</a></h4>
                                <p>Card</p>
                                <div>
                                    <a :href="asset('images/portfolio/card2.jpg')}}" class="link-preview"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web" data-wow-delay="0.1s">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('images/portfolio/web2.jpg') }}" class="img-fluid" alt="" />
                            <div class="portfolio-info">
                                <h4><a href="#">Web 2</a></h4>
                                <p>Web</p>
                                <div>
                                    <a :href="asset('images/portfolio/web2.jpg')}}" class="link-preview"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app" data-wow-delay="0.2s">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('images/portfolio/app3.jpg') }}" class="img-fluid" alt="" />
                            <div class="portfolio-info">
                                <h4><a href="#">App 3</a></h4>
                                <p>App</p>
                                <div>
                                    <a :href="asset('images/portfolio/app3.jpg')}}" class="link-preview"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('images/portfolio/card1.jpg') }}" class="img-fluid" alt="" />
                            <div class="portfolio-info">
                                <h4><a href="#">Card 1</a></h4>
                                <p>Card</p>
                                <div>
                                    <a :href="asset('images/portfolio/card1.jpg')}}" class="link-preview"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card" data-wow-delay="0.1s">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('images/portfolio/card3.jpg') }}" class="img-fluid" alt="" />
                            <div class="portfolio-info">
                                <h4><a href="#">Card 3</a></h4>
                                <p>Card</p>
                                <div>
                                    <a :href="asset('images/portfolio/card3.jpg')}}" class="link-preview"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web" data-wow-delay="0.2s">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('images/portfolio/web1.jpg') }}" class="img-fluid" alt="" />
                            <div class="portfolio-info">
                                <h4><a href="#">Web 1</a></h4>
                                <p>Web</p>
                                <div>
                                    <a :href="asset('images/portfolio/web1.jpg')}}" class="link-preview"
        ...
        <section id="clients" class="section-bg">
            <div class="container">
                ...
                <div class="row no-gutters clients-wrap clearfix wow fadeInUp">
                    ...
                    <div class="col-lg-3 col-md-4 col-xs-6">
                        <div class="client-logo">
                            <img src="{{ asset('images/clients/client-7.png') }}" class="img-fluid" alt="" />
                        </div>
                    </div>

                    <div class="col-lg-3 col-md-4 col-xs-6">
                        <div class="client-logo">
                            <img src="{{ asset('images/clients/client-8.png') }}" class="img-fluid" alt="" />
                        </div>
                    </div>
                </div>
            </div>
